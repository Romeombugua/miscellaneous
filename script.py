...
file1 = pd.read_csv('oldgeneral.csv')
file2 = pd.read_csv('general.csv')
...
name_column_name = 'Name'  # Replace 'Name' with the actual column name if it's different
...
file2_cleaned.to_csv('file2_cleaned.csv', index=False)
